...
begin
	select clienteID,nombreClientes,apellidoClientes,nitClientes,direccionClientes,telefonoClientes,
...
END$$
DELIMITER ;
CALL sp_agregarCompra(1234, '2024-02-06', "ejemplo", 05.00);
CALL sp_agregarCompra(4567, '2024-04-08', "ejemplo2", 45.00);
CALL sp_agregarCompra(8910, '2024-05-10', "ejemplo3", 15.00);
-- ----|--|-|-----------------------------------|-|-|--|-|-------------------------------------------||
...
-- ----|--|-|-----------------------------------|-|-|--|-|-------------------------------------------||
									-- PROCEDIMIENTO AGREGAR TelefonoProveedor --
-- ----|--|-|-----------------------------------|-|-|--|-|-------------------------------------------||
DELIMITER $$
CREATE PROCEDURE sp_agregarTelefonoProveedor(IN codigoTelefonoProveedorIn INT,IN numeroPincipalIn VARCHAR(8),IN numeroSecundarioIn VARCHAR(60),
IN observacionesIn VARCHAR(45),IN codigoProveedorIn INT)
BEGIN
    INSERT INTO TelefonoProveedor(codigoTelefonoProveedor, numeroPincipal, numeroSecundario, observaciones, codigoProveedor)
    VALUES(codigoTelefonoProveedorIn, numeroPincipalIn, numeroSecundarioIn, observacionesIn, codigoProveedorIn);
END$$
DELIMITER ;
CALL sp_agregarTelefonoProveedor(1, '123456-e5', 'Proveedor 1', 'Apellidos Proveedor', '123 Calle kinal, Ciudad', 'Empresa 1', 'Caspers Kinals', 'www.proveedor1.com');
CALL sp_agregarTelefonoProveedor(2, '18181-e8', 'Proveedor 2', 'Apellidos Proveedor 1', '15 Calle avenida 65, Ciudad Guatemala', 'Empresa 2', 'Anthony Escobar Kinals', 'www.proveedor2.com');
CALL sp_agregarTelefonoProveedor(3, '8484d-8w', 'Proveedor 3', 'Apellidos Proveedor 2', 'Calle 85 avenida 57 kinals-lops, Guatemala', 'Empresa 3', 'lisa Kinals', 'www.proveedor3.com');
-- ----|--|-|-----------------------------------|-|-|--|-|-------------------------------------------||
									-- PROCEDIMIENTO LISTAR TelefonoProveedor --
-- ----|--|-|-----------------------------------|-|-|--|-|-------------------------------------------||
DELIMITER $$
CREATE PROCEDURE sp_listarProveedores()
BEGIN
...
CALL sp_listarProveedores();
-- ----|--|-|-----------------------------------|-|-|--|-|-------------------------------------------||
									-- PROCEDIMIENTO buscar TelefonoProveedor --
-- ----|--|-|-----------------------------------|-|-|--|-|-------------------------------------------||
delimiter $$
create procedure sp_buscarProveedor(in codigoProveedorIn int)
begin
...
delimiter ; 
-- ----|--|-|-----------------------------------|-|-|--|-|-------------------------------------------||
									-- PROCEDIMIENTO ACTUALIZAR TelefonoProveedor --
-- ----|--|-|-----------------------------------|-|-|--|-|-------------------------------------------||
DELIMITER $$
CREATE PROCEDURE sp_actualizarProveedor(IN codigoProveedorIn INT,IN nitProveedorIn VARCHAR(10),IN nombreProveedorIn VARCHAR(60),IN apellidosProveedorIn VARCHAR(60),
IN direccionProveedorIn VARCHAR(150),IN razonSocialIn VARCHAR(60), IN contactoPrincipalIin VARCHAR(100),IN paginaWebIn VARCHAR(50))
...
DELIMITER ;
-- ----|--|-|-----------------------------------|-|-|--|-|-------------------------------------------||
									-- PROCEDIMIENTO ELIMINAR TelefonoProveedor --
-- ----|--|-|-----------------------------------|-|-|--|-|-------------------------------------------||
DELIMITER $$
CREATE PROCEDURE sp_eliminarTelefonoProveedor(IN codigoProveedorIn INT)
BEGIN
